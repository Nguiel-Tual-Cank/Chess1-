...
public class GamePanel extends JPanel implements Runnable {
    ...
    private void update() {
        ...
        if (promotion) {
            ...
            if (mouse.pressed) {
                if (activeP == null) {
                    // If th activeP is null, check if you can pick up a piece
    ...
    private void simulate() {
        ...
        // This is basically for restoring the moved piece during the simulation
        copyPieces(pieces, simPieces);
    ...
    public void paintComponent(Graphics g) {
        ...
        if (promotion) {
            g2.drawString("Promote to:", 840, 1500);
            for (Piece piece : promoPieces) {
